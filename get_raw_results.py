...
if __name__ == '__main__':
    ...
    parser.add_argument('--raw_results_path', type=str, required=True, help='Path to store raw annotation results')
    ...
    assignments.to_csv(args.raw_results_path, index=False)
